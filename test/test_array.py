...
from pyquboc import Binary, Spin, Array, Num
...
class TestArray(unittest.TestCase):
    ...
    def test_array_from_list(self):
        ...
        self.assertTrue(array[[0, 1], 0] == Array(
            [Binary('x0'), Binary('x2')]))
    ...
    def test_array_dot(self):
        ...
        i, j, k, m = (1, 1, 3, 2)
        self.assertTrue(array_a.dot(array_b)[i, j, k, m] == sum(array_a[i, j, :] * array_b[k, :, m]))
    ...
    def test_array_matmul(self):
        ...
        self.assertTrue((array_a.matmul(array_b))[
                        0] == array_a[0].matmul(array_b))
